...
public class AdminUsuarioController {
    ...
    @GetMapping
    public ResponseEntity<UsuarioDTO> getAdminProfile() {
        try {
    ...
    @PutMapping
    public ResponseEntity<UsuarioDTO> updateAdminProfile(@RequestBody ActualizarPerfilDTO actualizarPerfilDTO) {
        try {
            Usuario usuario = securityService.getCurrentUser();
            if (usuario == null) {
                return ResponseEntity.notFound().build();
