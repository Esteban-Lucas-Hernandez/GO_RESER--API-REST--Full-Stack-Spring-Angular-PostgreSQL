...
\restrict iVdYTFqqIAtcyD683A2eoHCiotkr7PDDxdve0GIJW2GnVv4dSD5rA1n42Qa2k0Y
...
--
-- Name: chat_intents_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.chat_intents ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.chat_intents_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY public.chat_intents
    ADD CONSTRAINT chat_intents_pkey PRIMARY KEY (id);
...
\unrestrict iVdYTFqqIAtcyD683A2eoHCiotkr7PDDxdve0GIJW2GnVv4dSD5rA1n42Qa2k0Y
